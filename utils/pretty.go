...
// Thanks to https://github.com/hokaccha/go-prettyjson/blob/master/prettyjson.go
...
// Marshal will marshal and formats JSON data.
...
// Format will format JSON string.
...
// FormatText :: colorize text
func FormatText(data []byte) string {
	c := color.New(color.FgBlue, color.Bold)
	return c.SprintfFunc()(string(data))
}
